      ...
      <div className="space-y-4">
        ...
        <section className="rounded-2xl border border-slate-200/70 bg-white/80 p-6 dark:border-slate-800/70 dark:bg-slate-900/60">
          ...
          <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
            Управление токенами перенесено в настройки аккаунта. Один токен покрывает все репозитории, доступные пользователю.
          </p>
          <Link
            to="/account"
            className="mt-3 inline-flex items-center justify-center rounded-full border border-slate-200 px-3 py-1 text-sm font-semibold text-primary hover:bg-primary/10 dark:border-slate-700 dark:hover:bg-slate-800"
          >
